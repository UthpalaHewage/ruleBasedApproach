...
WELCOME_BACK_P1 = [{'LOWER': 'welcome'}, {'LOWER': 'back'}, {'IS_PUNCT': True, 'OP': '?'}]
...
AND_FINALLY_P1 = [{'LOWER': 'and'},{'LOWER': 'finally'}, {'IS_PUNCT': True, 'OP': '?'}]
WHERE_AS_P1 = [{'LOWER': 'whereas'}, {'IS_PUNCT': True, 'OP': '?'}]
...
dict_of_patterns.update({"WELCOME_BACK_P1": WELCOME_BACK_P1})
...
dict_of_patterns.update({"AND_FINALLY_P1": AND_FINALLY_P1})
dict_of_patterns.update({"WHERE_AS_P1": WHERE_AS_P1})
