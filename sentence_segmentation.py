...
class SentenceSegmentation(object):
    ...
    def sent_segment(self):
        ...
        with open('files/collection/selected 6 transcripts/extra/v_2.txt', 'r') as file:
        # with open('files/collection/selected 6 transcripts/extra/8.2 Paragraphs.txt','r') as file:
